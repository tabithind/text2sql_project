...
class SQLServerMCP(BaseMCP):
    def __init__(self):
        self._connections: Dict[str, Any] = {}
        self.connector = ConnectorFactory.get_connector('sqlserver')
    ...
    def execute_read_query(self, connection_id: str, query: str, max_rows: int = 500, utilisateur_id: int = 0, base_id: int = 0) -> Dict[str, Any]:
        ...
        try:
            if "top" not in q_lower:
                # Basic injection of TOP max_rows, very naive approach for demonstration
            ...
            with conn.cursor() as cursor:
                ...
                # pyodbc Row objects need to be converted to list
